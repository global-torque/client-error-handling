...
function resolveOptions(options: SanitizeOptions = {}) {
  return {
...
function asSerializablePrimitive(value: unknown): SerializableValue {
...
function sanitizeString(value: string, options: ReturnType<typeof resolveOptions>): string {
  try {
